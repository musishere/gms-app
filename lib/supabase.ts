...
export const GRAVE_COLS =
  'id, graveyardId:graveyard_id, graveNumber:grave_number, section, row, column:grave_col, latitude, longitude, status, size, price, occupiedBy:occupied_by, burialId:burial_id, lastMaintenanceDate:last_maintenance_date, notes, reservedUntil:reserved_until, createdAt:created_at';
...
export const CERT_COLS =
  'id, burialId:burial_id, deceasedName:deceased_name, issuedTo:issued_to, requestedBy:requested_by, certificateNumber:certificate_number, status, issuedAt:issued_at, notes, verificationCode:verification_code, createdAt:created_at';
...
export const BOOKING_COLS =
  'id, graveyardId:graveyard_id, graveId:grave_id, bookedBy:booked_by, slotDate:slot_date, slotTime:slot_time, deceasedName:deceased_name, deceasedCnic:deceased_cnic, dateOfDeath:date_of_death, causeOfDeath:cause_of_death, address, contactName:contact_name, contactPhone:contact_phone, deceased, notes, status, approvedBy:approved_by, approvedAt:approved_at, expiresAt:expires_at, createdAt:created_at';
